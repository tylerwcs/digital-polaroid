...
const MASTHEAD_TOP = parseInt(process.env.EXPORT_MASTHEAD_TOP || '150', 10);     // masthead top margin (px)
...
const FLOAT_AMPLITUDE = parseInt(process.env.EXPORT_FLOAT_AMP || '40', 10);    // vertical float (px)
