...
const MASTHEAD_TOP = parseInt(process.env.EXPORT_MASTHEAD_TOP || '300', 10);     // masthead top margin (px)
const BUBBLE_WIDTH = parseInt(process.env.EXPORT_BUBBLE_WIDTH || '912', 10);   // overlay bubble width (px)
const BUBBLE_Y_OFFSET = parseInt(process.env.EXPORT_BUBBLE_Y_OFFSET || '320', 10); // push bubble below center (px)
